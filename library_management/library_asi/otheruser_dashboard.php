...
td, a{
   ...
   include("data_class.php");
    ?>
           <div class="container">
            <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/home_img.png" height = "200" width = "400"/></div>
            <div class="leftinnerdiv">
                <Button class="greenbtn btn" >Welcome</Button>
                <Button class="greenbtn btn" onclick="openpart('myaccount')"> My Account</Button>
                <Button class="greenbtn btn" onclick="openpart('requestbook')"> Request Book</Button>
                <Button class="greenbtn btn" onclick="openpart('issuereport')"> Book Report</Button>
            ...
            <label style="font-size:25px;color:black;margin-top:5px;" >My Account</label>
             <?php
            $u=new data;
            $u->setconnection();
            ...
            <tr>    
            <td><p style="color:black">Person Name:</p></td><td><p><?php echo $name ?></p></td>
            </tr>
            <tr>
            <td><p style="color:black">Person Email:</p></td><td><p><?php echo $email ?></p></td>
           </tr>
            <tr>
            <td><p style="color:black">Account Type:</p></td><td><p><?php echo $type ?></p></td>
           </tr>
           </table>
            </div>
            </div>
            ...
            <div class="rightinnerdiv">   
            <div id="issuereport" class="innerright portion" style="<?php  if(!empty($_REQUEST['returnid'])){} else {echo "display:none"; }?>">
            <label style="font-size:25px;color:black;margin-top:5px;" >ISSUE RECORD</label>
            ...
            <label style="font-size:25px;color:black;margin-top:0px;" >Request Book</label>
            ...
            foreach($recordset as $row){
                $table.="<tr>";
               "<td>$row[0]</td>";
               $table.="<td><img src='uploads/$row[1]' width='100px' height='100px' style='border:1px solid #333333;margin:7px;'></td>";
               $table.="<td>$row[2]</td>";
                $table.="<td>$row[4]</td>";
                $table.="<td>$row[6]</td>";
                $table.="<td>$row[7]</td>";
